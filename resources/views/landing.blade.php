...
<body class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white min-h-screen">
    ...
    <nav class="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/40 border-b border-white/10">
        <div class="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <img src="{{asset('img/Logo-MBG.png')}}" alt="Logo" class="h-12 w-auto">
                <span class="text-2xl font-bold">SPPG PASEH CIGENTUR</span>
            </div>
    ...
    <section class="pt-32 pb-24 text-center px-6">
        <div class="max-w-5xl mx-auto">
            <h1 class="text-5xl md:text-7xl font-extrabold leading-tight mb-6">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400"></span>
            </h1>
            <p class="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
                Kelola absensi, data karyawan, dan laporan secara digital — cepat, akurat, dan aman.
            </p>
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                @foreach([
                    ...
                    ['Laporan Otomatis', 'Rekap Laporan, export Excel & PDF'],
    ...
    <footer class="py-12 text-center border-t border-white/10">
        <p class="text-lg">© {{ date('Y') }} <strong>SPPG PASEH CIGENTUR</strong>. All rights reserved.</p>
        </p>
    </footer>
</body>
</html>