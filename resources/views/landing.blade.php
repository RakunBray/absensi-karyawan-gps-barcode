    ...
    <section class="pt-32 pb-24 text-center px-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <a href="{{ route('login') }}" class="px-12 py-5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-xl font-bold rounded-full shadow-2xl transform hover:scale-105 transition">
                    Masuk Sekarang
                </a>
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                @foreach([
                    ...
                    ['Import/Export Data', 'Migrasi data cepat dan mudah'],
                    ['Mobile Friendly', 'Bisa diakses dari HP tanpa aplikasi']
                ] as $fitur)
